...
/**
 * BookingDetailsSearch represents the model behind the search form about `common\models\BookerDetails`.
 */
class BookingDetailsSearch extends BookerDetails
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'travellers_count', 'package'], 'integer'],
