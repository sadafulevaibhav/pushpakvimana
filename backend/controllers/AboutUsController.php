...
class AboutUsController extends BaseController
{
        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($request->isGet) {
                ...
                $model->updated_at = date('Y-m-d H:i:s'); // Update the created_at field
                ...
                return [
                    ...
                    'title' => "Create new AboutUs",
                    'content' => '<span class="text-success">Create AboutUs success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-secondary float-left', 'data-bs-dismiss' => "modal"]) .
    ...
    /**
     * Delete an existing AboutUs model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing AboutUs model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
