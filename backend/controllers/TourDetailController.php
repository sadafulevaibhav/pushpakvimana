...
class TourDetailController extends Controller
{
    ...
    {
        $searchModel = new TourDetailSearch();
    ...
    /**
     * Displays a single TourDetail model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TourDetail model.
    ...
    /**
     * Updates an existing TourDetail model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing TourDetail model.
     * For ajax request will return json object
    ...
    /**
     * Finds the TourDetail model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TourDetail the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TourDetail::findOne($id)) !== null) {
            return $model;
        } else {
