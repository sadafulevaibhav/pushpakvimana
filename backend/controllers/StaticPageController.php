...
class StaticPageController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                ...
                // Explicitly set the description from POST data
                $model->description = $request->post('StaticPage')['description'];
                if ($model->save()) {
                    return [
                        'forceReload' => '#crud-datatable-pjax',
                        'title' => "Create new StaticPage",
                        'content' => '<span class="text-success">Create StaticPage success</span>',
                        'footer' => Html::button('Close', ['class' => 'btn btn-secondary float-left', 'data-dismiss' => "modal"]) .
    ...
    /**
     * Delete an existing StaticPage model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing StaticPage model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
