...
<div class="container-fluid container-carousal">
<?php
      echo Carousel::widget([
        'items' => [
          [
            'content' => '<div class="about-card card">
            ...
            'options' => ['class' => 'carousel-item col-md-4 active'],
          ],
          [
            'content' => '<div class="about-card card">
            <div class="card-body aboutus-card">
            ...
            'options' => ['class' => 'carousel-item col-md-4'],
            // 'caption' => '<h4>This is title</h4><p>This is the caption text</p>'
          ],
          [
            'content' => '<div class="about-card card">
