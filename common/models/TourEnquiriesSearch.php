...
class TourEnquiriesSearch extends TourEnquiries
{
    ...
    public function rules()
    {
        return [
            ...
            [['full_name', 'email', 'mobile', 'whats_app', 'travel_destination', 'travel_date', 'vaccation_type', 'created_date'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'full_name', $this->full_name])
            ...
            ->andFilterWhere(['like', 'vaccation_type', $this->vaccation_type]);
